package com.meuCondominio.Master.Models.Usuarios;
...
public class Usuario {
    ...
    @CollectionTable(name = "tb_roles_usuario", joinColumns = @JoinColumn(name = "id_usuario"))
    @Column(name = "role_id")
    ...
    public Usuario(Long id, String nome, String userName, String password, List<String> roles) {
        this.id = id;
        this.nome = nome;
